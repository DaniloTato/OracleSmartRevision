...
const navItems = [
  ...
  { to: '/task-manager', label: 'Gestor de Tareas', icon: HiOutlineClipboardList },
  { to: '/team-performance', label: 'Rendimiento del Equipo', icon: HiOutlineChartBar },
  { to: '/activity-log', label: 'Historial de Actividad', icon: HiOutlineClock },
]
                ...
                <NavLink to={to}>
                  {({ isActive }) => (
                    ...
                    >
                      ...
                      <Icon className="h-5 w-5 shrink-0 text-inherit" aria-hidden />
