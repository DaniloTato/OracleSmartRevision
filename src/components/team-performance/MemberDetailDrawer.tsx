      ...
      <div className="space-y-6">
         <section>
            ...
            <div className="grid grid-cols-2 gap-3">
               ...
               <KpiBox
                  label="Completadas (sprint actual)"
                  value={kpis.completadasSprintActual}
               />
               <KpiBox
                  label="Promedio variación (h)"
                  value={kpis.promedioVariacion}
               />
               <KpiBox
                  label="Score productividad"
                  value={kpis.scoreProductividad}
                  suffix="%"
               />
               <KpiBox
                  label="Tendencia"
                  value={kpis.tendencia === 'up' ? '↑' : '↓'}
               />
      ...
      <div className="space-y-4">
         ...
         <ul className="space-y-3">
            {strengths.map((s, i) => (
               ...
               >
                  <span className="text-[var(--color-oracle-orange)] shrink-0">
                     •
                  </span>
                  {s}
               </li>
...
function ProductividadTab({ userId }: { userId: number }) {
   ...
   return (
      <div className="space-y-4">
         <p className="text-sm text-[var(--color-text-muted)]">
            Medición de la productividad: Antes (línea base) vs Después
            (actual).
         </p>
