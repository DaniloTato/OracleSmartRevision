...
export const mockProductivityByUser: UserProductivity[] = mockUsers.map(
   (user) => ({
      userId: user.id,
...
export function getProductivityByUserId(
   userId: number
): UserProductivity | undefined {
